...
import {LabelKey, logger, Logger, MeasureUnit, Metrics, Stats} from '@opencensus/core';
import * as assert from 'assert';

import {StackdriverStatsExporter} from '../src/stackdriver-stats';
...
//   afterEach(() => {
//     process.env.GOOGLE_APPLICATION_CREDENTIALS =
//     GOOGLE_APPLICATION_CREDENTIALS; exporterTestLogger.cleanAll();
//   });

//   //   /* Should create a Stackdriver Metric Descriptor */
//   //   describe('Create Stackdriver Metric Descriptors', () => {
//   //     it('Should create a MeasureDouble with Metric Kind Gauge Metric
//   //     Descriptor',
//   //        async () => {
//   //          if (dryrun) {
...
//   //                lastValueDoubleView.description);
//   //            assert.strictEqual(
//   //                metricDescriptor.displayName,
//   //                lastValueDoubleView.measure.name);
//   //            assert.strictEqual(metricDescriptor.metricKind,
//   //            MetricKind.GAUGE);
//   //            assert.strictEqual(metricDescriptor.valueType,
//   //            ValueType.DOUBLE); assert.strictEqual(
//   //                metricDescriptor.unit, lastValueDoubleView.measure.unit);
//   //          });
//   //        });

//   //     it('Should create a MeasureDouble with Metric Kind Cumulative Metric
//   //     Descriptor',
//   //        async () => {
//   //          if (dryrun) {
//   //            nocks.metricDescriptors(PROJECT_ID, null, null, false);
...
//   //     it('Should create a MeasureInt64 with Metric Kind Cumulative Metric
//   //     Descriptor',
//   //        async () => {
//   //          if (dryrun) {
//   //            nocks.metricDescriptors(PROJECT_ID, null, null, false);
...
//   //            assert.strictEqual(metricDescriptor.valueType,
//   ValueType.INT64);
//   //            assert.strictEqual(metricDescriptor.unit,
//   //            sumINT64View.measure.unit);
//   //          });
//   //        });

//   //     it('Should create a MeasureInt64 with Metric Kind Gauge Metric
//   //     Descriptor',
//   //        async () => {
//   //          if (dryrun) {
//   //            nocks.metricDescriptors(PROJECT_ID, null, null, false);
...
//   //            assert.strictEqual(
//   //                metricDescriptor.description,
//   //                lastValueINT64View.description);
//   //            assert.strictEqual(
//   //                metricDescriptor.displayName,
//   //                lastValueINT64View.measure.name);
//   //            assert.strictEqual(metricDescriptor.metricKind,
//   //            MetricKind.GAUGE);
//   //            assert.strictEqual(metricDescriptor.valueType,
//   ValueType.INT64);
...
//   distributionDoubleView.measure.unit);
//   //          });
//   //        });
//   //   });
...
//   //                .then(() => {
//   //                  const timeSeries =
//   exporterTestLogger.debugBuffer[1][0];
//   //                  assert.strictEqual(
//   //                      timeSeries.metric.type,
//   // `${StackdriverStatsExporter.CUSTOM_OPENCENSUS_DOMAIN}/${
//   //                          lastValueDoubleView.name}`);
//   //                  assert.deepEqual(timeSeries.metric.labels,
//   //                  measurement2.tags);
//   //                  assert.strictEqual(timeSeries.resource.type,
//   //                  resourceType);
//   //                  assert.ok(timeSeries.resource.labels.project_id);
//   //                  assert.strictEqual(
//   //                      timeSeries.resource.labels.project_id,
//   //                      resourceLabels.project_id);
//   //                  assert.strictEqual(timeSeries.metricKind,
//   //                  MetricKind.GAUGE);
//   //                  assert.strictEqual(timeSeries.valueType,
//   //                  ValueType.DOUBLE); assert.ok(timeSeries.points.length >
//   //                  0); assert.deepStrictEqual(
...
//   //           assert.ok(timeSeries.points.length > 0);
//   //           assert.deepStrictEqual(timeSeries.points[0].value.int64Value,
//   //           75);
//   //         });
//   //       });
//   //     });
...
//   //     it('Should create a distribution Time Series with bound 0 as first
//   //     item',
//   //        async () => {
//   //          if (dryrun) {
//   //            nocks.metricDescriptors(PROJECT_ID, null, null, false);
...
//   //                exporter.onRecord([distributionDoubleView],
//   measurement1);
...
//   //                      exporterTestLogger.debugBuffer[1][0];
//   //                      assert.deepStrictEqual(
//   // timeSeries.points[0].value.distributionValue.count,
//   //                          1);
//   //                      assert.deepStrictEqual(
//   // timeSeries.points[0].value.distributionValue.mean,
//   //                          25);
//   //                      assert.deepStrictEqual(
//   //                          timeSeries.points[0]
...
//   //                      assert.deepStrictEqual(
//   //                          bucketOptions.explicitBuckets.bounds, [0, 10,
//   25,
//   //                          30]);
//   //                      assert.deepStrictEqual(bucketCounts, [0, 0, 0, 1,
//   0]);
//   //                    });
//   //              });
//   //        });
...
//   //   /**
//   //    * Should send a Stackdriver Metric Descriptor and Time Series to
//   //    Stackdriver.
//   //    */
//   //   describe('Send data to Stackdriver', () => {
//   //     const viewMetricDescriptor = new BaseView(
//   //         'test/metricDscriptorSend', measureDouble,
//   //         AggregationType.LAST_VALUE, tagKeys, 'Metric Descriptor Send');
//   //     const viewTimeSeries = new BaseView(
//   //         'test/timeSeriesSend', measureDouble,
...
//   //           assert.strictEqual(
//   //               metricDescriptor.description,
//   //               viewMetricDescriptor.description);
//   //           assert.strictEqual(
//   //               metricDescriptor.displayName,
//   //               viewMetricDescriptor.measure.name);
//   //           assert.strictEqual(metricDescriptor.metricKind,
//   //           MetricKind.GAUGE);
//   assert.strictEqual(metricDescriptor.valueType,
//   //           ValueType.DOUBLE); assert.strictEqual(
...
//   //           assert.ok(timeSeries.points.length > 0);
//   //           assert.deepStrictEqual(timeSeries.points[0].value.doubleValue,
//   //           25);
//   //         });
//   //       });
//   //     });
...
//   //       it('.onRecord() Should not fail by wrong projectId, but trigger
//   //       onMetricUploadError with error',
//   //          (done) => {
//   //            nock('https://monitoring.googleapis.com')
//   //                .persist()
//   //                .intercept(
//   //                    '/v3/projects/' + WRONG_PROJECT_ID + '/timeSeries',
//   //                    'POST')
//   //                .reply(403, 'Permission denied');
...
//   => {
//   //           prefixExporter = new
//   StackdriverStatsExporter(exporterOptions);
//   //           stats.registerExporter(prefixExporter);
//   //           await
//   prefixExporter.onRegisterView(viewMetricDescriptor).then(()
//   //           => {
...
//   //           prefixExporter = new
//   //           StackdriverStatsExporter(prefixExporterOptions);
//   //           stats.registerExporter(prefixExporter);
//   //           await
//   prefixExporter.onRegisterView(viewMetricDescriptor).then(()
//   //           => {
...
//   //             const metricDescriptor: MetricDescriptor =
//   //                 exporterTestLogger.debugBuffer[0];
//   //             assert.strictEqual(metricDescriptor.type,
//   `${prefix}/${name}`);
//   //           });
//   //         });
//   //       });
...
//   //               .then(() => {
//   //                 const timeSeries = exporterTestLogger.debugBuffer[0][0];
//   //                 assert.strictEqual(timeSeries.metric.type,
//   //                 `${prefix}/${name}`);
//   //               });
//   //         });
//   //       });
...
//   //         failExporter.onRegisterView(viewMetricDescriptor).catch((err) =>
//   {
//   //           assert.ok(err.message.indexOf('Simulated Network Error') >=
//   0);
//   //           failExporter.close();
//   //           done();
//   //         });
...
//   //       it('.onRecord() Should not fail by network error, but trigger
//   //       onMetricUploadError with error',
//   //          (done) => {
//   //            nock('https://monitoring.googleapis.com')
//   //                .persist()
//   //                .intercept('/v3/projects/' + PROJECT_ID + '/timeSeries',
//   //                'POST') .reply(443, 'Simulated Network Error');
