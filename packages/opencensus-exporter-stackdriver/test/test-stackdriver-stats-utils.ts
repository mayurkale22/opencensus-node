...
describe('Stackdriver Stats Exporter Utils', () => {
  ...
  describe('createPoint()', () => {
    ...
    it('should return a Stackdriver Point', () => {
      ...
      assert.deepStrictEqual(pt.value, {doubleValue: 12345678.2});
      // assert.equal(typeof pt.interval.endTime, 'number');
      // assert.equal(pt.interval.startTime, 'number');
    });
    ...
    it('should return a Stackdriver Cumulative Point', () => {
      ...
      assert.deepStrictEqual(pt.value, {int64Value: 12345678});
      // assert.equal(typeof pt.interval.endTime, 'number');
      // assert.equal(pt.interval.startTime, 'number');
    });
    ...
    it('should return a Stackdriver Distribution Point', () => {
      ...
      assert.deepStrictEqual(pt.value, {
        distributionValue: {
          count: 3,
  ...
  describe('createTimeSeriesList()', () => {
    ...
    const defaultResource = {type: StackdriverStatsExporter.GLOBAL, labels: {}};
    const customResource = {
      type: StackdriverStatsExporter.GLOBAL,
